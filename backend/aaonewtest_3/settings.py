"""
Django settings for aaonewtest_3 project.
...
ROOT_URLCONF = 'aaonewtest_3.urls'
...
WSGI_APPLICATION = 'aaonewtest_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aaonewtest_3 API",
    "DESCRIPTION": "API documentation for aaonewtest_3 App",
    "VERSION": "v1",
}
